...
nv_register_t ptimer_registers[] = {
    { NV4_PTIMER_INTR, "PTIMER - Interrupt Status", NULL, NULL},
    { NV4_PTIMER_INTR_EN, "PTIMER - Interrupt Enable", NULL, NULL,},
    { NV4_PTIMER_NUMERATOR, "PTIMER - Numerator", NULL, NULL, },
    { NV4_PTIMER_DENOMINATOR, "PTIMER - Denominator", NULL, NULL, },
    { NV4_PTIMER_TIME_0_NSEC, "PTIMER - Time0", NULL, NULL, },
    { NV4_PTIMER_TIME_1_NSEC, "PTIMER - Time1", NULL, NULL, },
    { NV4_PTIMER_ALARM_NSEC, "PTIMER - Alarm", NULL, NULL, },
